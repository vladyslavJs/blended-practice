...
//-------------------------------------
// Метод filter. 
// Використовується для створення нового масиву, який містить елементи, які задовольняють певний умовний вираз. Він перебирає кожен елемент масиву та повертає новий масив з елементами, для яких умова повертає true
